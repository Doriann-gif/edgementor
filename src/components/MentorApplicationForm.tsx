      ...
      <div className="w-full max-w-2xl relative">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-muted-foreground text-sm max-w-md mx-auto">
            Apply to become a verified mentor on the marketplace. Prove your track record and start earning.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl border border-border bg-card p-6 sm:p-8 space-y-7 shadow-xl shadow-black/20">
          ...
          <div className="space-y-2">
            ...
            <Select value={experience} onValueChange={setExperience}>
              <SelectTrigger className="bg-muted border-border focus:border-primary/50">
                <SelectValue placeholder="Select experience" />
              </SelectTrigger>
              <SelectContent>
                {["1-2 years", "3-5 years", "5-8 years", "8-10 years", "10+ years"].map((yr) => (
          ...
          <div className="space-y-2">
            ...
            <label className="flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-border bg-muted/50 p-8 transition-colors hover:border-primary/30 hover:bg-muted">
              ...
              <span className="text-sm font-medium text-foreground">
                {proofFile ? proofFile.name : "Upload statement or screenshot"}
              </span>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="bio"
              placeholder="Describe your trading journey, edge, and what students can expect..."
              rows={4}
              value={bio}
              onChange={(e) => setBio(e.target.value)}
              className="bg-muted border-border focus:border-primary/50 transition-colors resize-none"
            />
          </div>

          {/* Submit */}
          <Button type="submit" className="w-full h-12 text-sm font-semibold tracking-wide">
            Submit Application
          </Button>

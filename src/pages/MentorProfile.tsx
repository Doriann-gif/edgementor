  ...
  return (
    ...
    <div className={`min-h-screen ${isElite ? "bg-slate-950" : "bg-background"}`}>
      ...
      >
        ...
        <motion.div
          variants={fadeUp}
          className="relative rounded-2xl mb-5 h-32 overflow-hidden group"
          style={{ background: (mentor as any).banner_color || "#6d28d9" }}
        >
          ...
          {isOwner && !showColorPicker && (
            <button
              onClick={() => { setPickerColor((mentor as any).banner_color || "#6d28d9"); setShowColorPicker(true); }}
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // HSL to hex with 60% saturation, 40% lightness
                    const s = 0.6, l = 0.4;
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="ghost" size="sm" className="text-xs h-8" onClick={() => setShowColorPicker(false)}>
                    Cancel
                  </Button>
                </div>
              </div>
